...
//    }
        ...
        @Transactional
        public Book createBookWithDetail(Book book, BookDetail bookDetail){
        ...
        public List<Book> createBooksWithCategory(List<Book>books, Category category){
            category.setBooks(books);
            for(Book book: books){
                book.setCategory(category);
            }
        ...
        public Book updateBook(Long id, Book updatedBook){
            ...
            existingBook.setBookDetail(updatedBook.getBookDetail());
